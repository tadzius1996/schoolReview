...
function Hero() {
  return (
    <>
    <div className='pb-[-2rem] h-[76vh] md:h-[82vh] lg:h-[72.9vh] mt-12 flex flex-col lg:flex-row'>
  ...
  <a href="#_" className="mt-5 relative inline-flex items-center justify-center inline-block p-4 px-5 py-3 overflow-hidden font-medium text-indigo-600 rounded-lg shadow-2xl group">
    ...
    <Link href='/schools'><span className="relative text-white">Search Schools</span></Link>
  </a>
</div>
