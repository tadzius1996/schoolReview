...
function Header() {
  return (
    <div className='flex justify-between pt-5 px-3 md:px-24'>
      <Link href='/'><div className='flex items-center'>
      <Image src={goatLogo} alt='logo' className='w-28 h-auto cursor-pointer'/>
      <h1 className='text-4xl font-semibold ml-[-1.7rem]'>School<span className='text-blue-900'>Scout</span></h1>
      </div>
      </Link>
        <div className='flex items-center gap-5'>
        <div className=" relative hidden lg:flex items-center h-10 flex-grow cursor-pointer ">
